...
const auto SESSION_BACKGROUND_SELECTED_COLOR = "B8B39D";
const auto TRACK_LIST_BACKGROUND_COLOR = "777777";
const auto SESSION_CLIP_TRIGGER_COLOR = "D9D9D9";
const auto SESSION_BORDER_COLOR = "5C5C5C";
const auto PLAY_COLOR = "90FF8D";
const auto RECORD_COLOR = "FF4444";
const auto STOP_COLOR = "FF675D";
const auto SOLO_COLOR = "00C2FF";
const auto STOPPING_COLOR = "90FF8D";
...
const auto BUTTON_COLOR_DEFAULT = "7F7F7F";
const auto BUTTON_COLOR_ACTIVE = "FFC20C";
const auto METER_BOTTOM_COLOR = "2DB82A";
const auto METER_MIDDLE_COLOR = "90FF8D";
const auto METER_TOP_COLOR = "90FF8D";
const auto METER_RED_COLOR = "FF0404";
