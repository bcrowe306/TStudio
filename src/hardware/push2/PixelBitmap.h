...
public:
  ...
  inline static pixel_t SPixelFromRGB(unsigned char r, unsigned char g,
                                      unsigned char b) {
  ...
  pixel_t *PixelData() { return pixelData_; }
...
private:
  pixel_t pixelData_[kWidth * kHeight]; /*!< static memory block to store the
                                           pixel values */
    };
